...
function onDragStart(source, piece) {
  // Disable scroll after picking up a chess piece.
  chrome.runtime.sendMessage({ type: "DISABLE_SCROLL" });
...
function onDrop(source, target) {
  ...
  removeGreySquares();
  // Enable scroll after dropping up a chess piece.
  chrome.runtime.sendMessage({ type: "ENABLE_SCROLL" });
